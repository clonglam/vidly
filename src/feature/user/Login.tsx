...
const Login = () => {
  ...
  const onSubmit: SubmitHandler<FormValues> = (data) => dispatch(loginUser(data))
  ...
  return (
    ...
    >
      ...
      >
        <p className='text-4xl font-bold text-white pt-6 pb-3'>Sign In</p>
        <form
        ...
        <div>
          <p className='text-zinc-500 font-[400] text-sm'>
            New to Vidly?
            <Link className='text-white font-[600]' to='/register'>
              Sign up now.
            </Link>
          </p>
        </div>
